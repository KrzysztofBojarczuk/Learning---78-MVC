...
using RunnWebApplication1.Data.Enum;
using RunnWebApplication1.Models;
using RunnWebApplication1.Repository;
using System;
...
namespace RunWebApplication1.Tests.Repository
{
    public class ClubRepositoryTests
    {
        private async Task<ApplicationDbContext> GetDbContext()
        {
            var options = new DbContextOptionsBuilder<ApplicationDbContext>()
                .UseInMemoryDatabase(databaseName: "ClubRepositoryTests")
                .Options;
        ...
        public async void ClubRepository_Add_ReturnsBool()
        {
            ...
            var dbContect = await GetDbContext();

            var clubRepository = new ClubRepository(dbContect);
